...
public enum ModArmorMaterials implements ArmorMaterial {
    DERMANTINE("dermantine", 26, new int[]{ 5, 9, 7, 4 }, 25,
            SoundEvents.ARMOR_EQUIP_GOLD, 4f, 2f, () -> Ingredient.of(AllItems.DERMANTINE.get()));
    ...
    public String getName() {
        return DermantineMod.MODID + ":" + this.name;
    }
